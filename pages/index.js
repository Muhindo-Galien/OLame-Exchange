...
export default function Home() {
  ...
  const renderButton = () => {
    ...
    if (liquidityTab) {
      return (
        <div>
          <div className={`py-2 px-3 border border-blue-600 rounded-md`}>
          ...
          <div>
            {utils.parseEther(reservedIcebear?.toString())?.eq(zero) ? (
              <div>
                <input
                  ...
                  className={`py-2 px-3 border border-blue-600 outline-none my-2 rounded-md mx-[2.5px]`}
                />
                <input
                  type="number"
                  ...
                  className={`py-2 px-3 border border-blue-600 outline-none my-2 rounded-md mx-[2.5px]`}
                />
                <button className={`py-2 px-3 bg-blue-600 my-2 rounded-md mx-[2.5px] text-gray-50`} onClick={_addLiquidity}>
                  Add
                </button>
              </div>
            ) : (
            ...
            <div>
              ...
              <button className={`py-2 px-3 bg-blue-600 my-2 rounded-md mx-[2.5px] text-gray-50`} onClick={_removeLiquidity}>
                Remove
              </button>
            </div>
          </div>
      ...
      return (
        <div>
          ...
          <button className={`py-2 px-3 bg-blue-600 my-2 rounded-md mx-[2.5px] text-gray-50`} onClick={_swapTokens}>
            Swap
          </button>
        </div>
      );
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Olame Exchange!</h1>
